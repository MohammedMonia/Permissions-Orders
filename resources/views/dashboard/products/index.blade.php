...
@section('content')
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><a href="{{ route('dashboard.products.index') }}"> @lang('site.products')</a></li>
                ...
                @if ($products->count() > 0)
                        ...
                        <tbody>
                            @foreach($products as $index=>$product)
                                ...
                                <td><img class="img-thumbnail" style="width: 100px;" src="{{ $product->image_path }}"></td>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('dashboard.products.edit', $product->id) }}" class="btn btn-info btm-sm"><i class="fa fa-edit"></i>@lang('site.edit')</a>
